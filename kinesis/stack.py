...
from aws_cdk import aws_kinesisfirehose as firehose, aws_iam as iam
from data_lake.base import BaseDataLakeBucket

class RawKinesisRole(iam.Role):

    def __init__(self, scope: core.Construct, deploy_env: str, data_lake_raw_bucket: BaseDataLakeBucket, **kwargs) -> None:
